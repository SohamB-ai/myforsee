            ...
            <div className="max-w-6xl mx-auto">
              <ExpandOnHover
                items={[
                  ...
                  {
                    title: "Backend",
                    description: "Scalable Node.js environment using Express for high-performance industrial data processing.",
                    icon: <Server className="size-6" />,
                    image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=800"
                  },
                  {
                    title: "AI",
                    description: "High-fidelity industrial reasoning and predictive analytics powered by Google Gemini 2.5 Flash API.",
                    icon: <Cpu className="size-6" />,
                    image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=800"
                  },
                  {
                    title: "Fine-tune",
                    description: "Optimized model performance using specialized industrial datasets (CMAPSS, AI4I, MetroPT) for predictive accuracy.",
                    icon: <Activity className="size-6" />,
                    image: "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?q=80&w=800"
                  },
                  {
                    title: "Database",
                    description: "Enterprise Knowledge Base and Distributed Local State for high-availability offline-first performance.",
